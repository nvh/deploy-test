...
export declare type CreateVisualElement<E, P = MotionProps> = (Component: string | React.ComponentType<P>, isStatic: boolean, options: VisualElementOptions<E>) => VisualElement<E>;
/**
